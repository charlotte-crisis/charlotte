...
draw_text(_xx, _yy, "Name:");
draw_text(_xx, _yy+16, (current_gender)?"Charlotte":"Charles");
...
if (select_row < 4) {
	...
	draw_text(_xx, _yy + 10 + 80 *select_row, "<            >");
	draw_set_font(fnt_body);
	draw_set_color(c_white);
} else {
...
for (var i = 0; i < array_length(current_clothes); i++) {
	draw_sprite_ext(clothing_top[current_gender][current_clothes[0]],	  -1, _xx, _yy, _sprite_scale, _sprite_scale, 0, c_white, 1);
	draw_sprite_ext(clothing_bottoms[current_gender][current_clothes[1]], -1, _xx, _yy, _sprite_scale, _sprite_scale, 0, c_white, 1);
	draw_sprite_ext(clothing_shoes[current_gender][current_clothes[2]],   -1, _xx, _yy, _sprite_scale, _sprite_scale, 0, c_white, 1);
}
draw_text(_xx, _yy + 320, "Confirm");
